...
('Giao lưu trao đổi dụng cụ thể thao', 'Trao đổi dụng cụ thể thao với các bạn học sinh khác', '2025-08-05 13:00:00', '2025-08-05 17:00:00', 'Sân trường', 10, 'Câu lạc bộ Thể thao', 'Mang theo dụng cụ thể thao cần trao đổi', 'pending');

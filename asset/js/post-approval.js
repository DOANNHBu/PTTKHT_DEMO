  ...
  filterAndRenderPosts() {
    ...
    if (this.currentFilter.status !== "all") {
      filteredPosts = filteredPosts.filter(
        (post) => post.status === this.currentFilter.status
      );
    }
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <button onclick="postApproval.showPostDetail('${
                          post.id
                        }')" class="btn btn-info">
                            Xem
                        </button>
                        <button onclick="postApproval.showEditForm('${
                          post.id
                        }')" class="btn btn-warning">
                            Sửa
                        </button>
                        <button onclick="postApproval.deletePost('${
                          post.id
      ...
      modal.innerHTML = `
                <div class="modal-content">
                    ...
                    <div class="post-detail-content">
                        ...
                        <p><strong>Giá:</strong> ${post.price.toLocaleString(
                          "vi-VN"
                        )} đ</p>
      ...
      modal.innerHTML = `
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editPostForm" onsubmit="postApproval.handleEdit(event, '${
                          post.id
                        }')">

class UserManager {
  ...
  filterAndRenderUsers() {
    const filteredUsers = this.users.filter(
      (user) => user.role_id.toString() === this.currentRole
    );
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <button class="btn btn-view" onclick="userManager.viewUser('${
                          user.id
                        }')">
                            Xem
                        </button>
                        <button class="btn btn-edit" onclick="userManager.editUser('${
                          user.id
                        }')">
                            Sửa
                        </button>
                        <button class="btn btn-danger" onclick="userManager.deleteUser('${
                          user.id
                        }')">
                            Xóa
                        </button>
